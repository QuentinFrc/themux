...
export type OldBaseColor = (typeof oldBaseColors)[number];
...
export type BaseColor = keyof typeof baseColorsV4;
export type BaseColors = typeof baseColorsV4;
